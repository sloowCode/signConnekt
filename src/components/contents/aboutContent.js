            ...
            <div className="container aboutUs">
                <Row className='about-row'>
                    ...
                    <Col><p className='aboutP'>For so many so many years now, the barrier of communication between the hearing  and  the hearing impaired  has been an undisputed challenge, causing the deaf to be misunderstood and mistreated. All of us share a need to be understood , yet  Parents with deaf children have been  unable to exchange meaningful ideas, emotions , thoughts and love with them , leaving the parents with great  worry and  and  discomfort , allowing the deaf to feel neglected and isolated .
                            ...
                            This brought up the establishment of <Link to='' className='signlink'>si<b className='signG'>G</b>n Connekt</Link> , a platform powered by <b className='nakwa'>Nakwa Arms Foundation</b> . </p></Col>
                </Row>
                ...
                <Row className='vision-row'>
                    ...
                    <Col><p className='vision'>The Vision of this platform is to make sign language a common language in schools , homes and  organisations , breaking the barrier between the deaf and hearing ,uniting them ,creating  job opportunities for both parties through sign language   and empowering them  as they are  being understood  well and  their talents  are being unleashed . You can support this vision by  joining the <Link to=''className='nakwa'>SiGn <b className='signG'>2</b> ShiNe</Link> campaign by <Link to=''><b className='nakwa'>Nakwa Arms Foundation</b></Link> , with just a Click. 
